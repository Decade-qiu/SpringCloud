...
public class ItemController {
    ...
    public void saveItem(@RequestBody ItemDTO item) {
        ...
        // 发送消息
        rabbitMqUtils.sendMessage("search.direct", "item.add", item.getId());
    }
    ...
    public void updateItem(@RequestBody ItemDTO item) {
        ...
        // 发送消息
        rabbitMqUtils.sendMessage("search.direct", "item.update", item.getId());
    }
    ...
    public void deleteItemById(@PathVariable("id") Long id) {
        ...
        // 发送消息
        rabbitMqUtils.sendMessage("search.direct", "item.delete", id);
    }
